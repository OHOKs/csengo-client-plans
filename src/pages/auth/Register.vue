<template>
  <div class="container" v-if="isWindowSizeEnoguh">
    <div class="login-box">
      ...
      <form @submit.prevent="handleLogin">
        ...
        <div class="user-box">
          <input v-model="om" type="number" required />
          <label>OM</label>
        </div>
        <div class="user-box">
        ...
        <p>Van már fiókod? <router-link to="/login" style="text-decoration: underline; color: white; font-weight: 700;">Lépj be itt!</router-link></p>
      </form>
    </div>
  </div>
...
.login-box .submit:hover {
  ...
  color: #fff;
  border-radius: 5px;
  box-shadow: 0 0 0px #fc2658, 0 0 25px #fc2658, 0 0 50px #fc2658,
    0 0 100px #fc2658;
}
